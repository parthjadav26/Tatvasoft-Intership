...
export class AddMissionComponent implements OnInit, OnDestroy {
  ...
  addMissionFormValid() {
    this.addMissionForm = this._fb.group({
      ...
      missionDescription: [null, Validators.required],
      startDate: [null, Validators.required],
      endDate: [null, Validators.required],
      missionThemeId: [null, Validators.required],
      missionSkillId: [null, Validators.required],
      missionImages: [null, Validators.required],
